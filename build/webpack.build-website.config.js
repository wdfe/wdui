...
module.exports = {
  entry: {
    ['wdui-website/js/index']: path.resolve(path.resolve(path.resolve(__dirname), '../docs/website'), './index.js')
  },
  output: {
  ...
  plugins: [
    ...
    new webpack.ProvidePlugin({
      hljs: path.resolve(path.resolve(path.resolve(__dirname), '../docs/website'), './assets/js/highlight/highlight.pack.js')
    }),
